...
var options={entrar:true,denegar:false}

if(options.entrar===true){

 console.log('si es true la propiedad entrar')   


}

if(options.denegar===false){

console.log('si es false la propiedad denegar')
